  ...
  return (
    <>
      <div className={styles.mobileNavbarContainer}>
        <Logo isSideMenuOpen={true} isMobile={true} />{" "}
        {/* Assuming Logo adapts or isSideMenuOpen can be true for mobile logo version */}
        <button
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <a
              href="https://github.com/matt765/eternal-motion"
              target="_blank"
